...
samphat = psycopg2.connect(host="10.100.53.25",   port=2345, database="soubhik_cluster", user="postgres", password="");
kushal = psycopg2.connect(host="10.100.54.83",port=2345, database="soubhik_cluster", user="postgres", password="");
niranjan= psycopg2.connect(host="10.100.53.121",port=5432, database="soubhik_cluster1", user="postgres", password="");
