...
samphat = psycopg2.connect(host="10.100.55.79",   port=2345, database="soubhik", user="postgres", password="");
kushal = psycopg2.connect(host="10.100.54.83",port=2345, database="soubhik", user="postgres", password="");
niranjan= psycopg2.connect(host="10.100.54.95",port=5432, database="soubhik", user="postgres", password="");
